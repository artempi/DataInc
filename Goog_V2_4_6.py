...
import pandas as pd
df1 = pd.read_csv("/home/artem/TEST3/Trump/dict_week4.csv")
df2 = pd.read_csv("/home/artem/TEST3/Trump/dict_week6.csv")
list1=df1['6'].values
list2=df1['0'].values
print(list1.tolist())
#print(df1)
...
dfV1.to_csv("./V2_week4.csv")

dfV2=pd.DataFrame(V2)
dfV2.to_csv("./V2_week6.csv")
